...
@Component({
  selector: 'app-zoom-pan-drag-circle',
  templateUrl: './zoom-pan-drag-circle.component.html',
  styleUrls: ['./zoom-pan-drag-circle.component.css']
})
export class ZoomPanDragCircleComponent implements OnInit {
